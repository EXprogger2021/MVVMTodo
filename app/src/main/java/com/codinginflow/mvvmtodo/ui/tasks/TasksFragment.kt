        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.taskEvent.collect { event ->
                when (event) {
                    ...
                    is TasksViewModel.TaskEvent.NavigfateToAddTaskScreen -> {
                    ...
                    TasksViewModel.TaskEvent.NavigateToDeleteAllCompletedDialog -> {
                        val actions = TasksFragmentDirections.actionGlobalDeleteAllCompletedDialogFragment()
